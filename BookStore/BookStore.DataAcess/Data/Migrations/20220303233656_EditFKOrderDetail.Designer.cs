...
namespace BookStore.DataAcess.Migrations
{
    ...
    [Migration("20220303233656_EditFKOrderDetail")]
    partial class EditFKOrderDetail
    {
            ...
            modelBuilder.Entity("BookOrderDetail", b =>
                {
                    ...
                    b.Property<Guid>("OrderDetailsBookId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("OrderDetailsOrderId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("BookId", "OrderDetailsOrderDetailId", "OrderDetailsBookId", "OrderDetailsOrderId");

                    b.HasIndex("OrderDetailsOrderDetailId", "OrderDetailsBookId", "OrderDetailsOrderId");
            ...
            modelBuilder.Entity("BookOrderDetail", b =>
                {
                    ...
                    b.HasOne("BookStore.Models.OrderDetail", null)
                        .WithMany()
                        .HasForeignKey("OrderDetailsOrderDetailId", "OrderDetailsBookId", "OrderDetailsOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
